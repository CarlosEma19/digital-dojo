...
const Graphic = () => {
  ...
  return (
    <section className="bg-revogreen">
      <motion.div
        className="w-full min-h-screen flex flex-col pt-32 pb-10"
        initial="offscreen"
        whileInView="onscreen"
        viewport={{ amount: 0.4, once: true }}
        variants={cardVariants}
      >
        <h2 className="text-5xl text-white font-bold text-center uppercase mb-16">
          Como Funciona
        </h2>
        ...
        <div className="container-small text-white grid grid-cols-1 md:grid-cols-10 auto-rows-auto gap-10">
          ...
          <div className="order-2 md:order-none md:col-start-1 md:col-span-3 md:row-start-1">
            ...
            <p>
              Nosso time entende a sua necessidade e monta um projeto
              personalizado com os melhores equipamentos.
            </p>
          </div>
          ...
          <div className="order-3 md:order-none md:col-start-8 md:col-span-3 md:row-start-1">
            ...
            <p>
              A Revo desenvolve e instala sua usina fotovoltaica com os melhores
          ...
          <div className="order-4 md:order-none md:col-start-8 md:col-span-3 md:row-start-2">
            ...
            <p>
              Você passa a gerar a sua própria energia de forma sustentável
          ...
          <div className="order-5 md:order-none md:col-start-1 md:col-span-3 md:row-start-2">
            ...
            <p>
              Temos uma equipe especializada na sua região disponível para
              qualquer suporte técnico que você precise
            </p>
          </div>
        </div>
      </motion.div>
