  ...
  return (
    <div className="w-full bg-revogreen">
      <footer className="container grid grid-cols-1 py-7">
        <div className="cima border-b-2 border-b-white pb-20 flex flex-col md:flex-row justify-between items-start md:items-end gap-4 md:gap-0">
        ...
        <div className="baixo text-white flex flex-col md:flex-row justify-between gap-6 py-10">
          <div>
