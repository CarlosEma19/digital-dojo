...
const About = () => {
  return (
    <div className='w-full h-screen grid grid-cols-2 bg-half py-44 tx-green'>
      <div className='container flex flex-col col-start-1'>
        <h2 className='text-4xl py-7 uppercase font-bold'>
          Quem Somos
        </h2>
      ...
      <div className='container flex flex-col col-start-2'>
        <div className='img'>
          <Image
            className="huawei w-full h-full object-cover"
            src="/huaweilogo.svg"
            alt="logo da huawei"
            width={386}
            height={386}
        ...
        <h2 className='text-3xl py-7 uppercase font-bold'>
