...
const About = () => {
  return (
    <div className='w-full h-screen bg-half py-44 text-primary'>
      <div className='container-small grid grid-cols-2'>
        <div className='container-small col-start-1'>
          <h2 className='text-4xl pb-7 uppercase font-bold text-primary'>
            Quem Somos
          </h2>
        ...
        <div className="container-small flex flex-col items-center col-start-2">
          <div className="topo flex gap-4 items-start pb-7">
            <div className="">
              <Image
